...
import (
	...
	v2 "github.com/apache/skywalking-banyandb/api/proto/banyandb/database/v2"
)
...
func (PairQuery_BinaryOp) EnumDescriptor() ([]byte, []int) {
	return file_banyandb_model_v2_query_proto_rawDescGZIP(), []int{1, 0}
}
...
type PairQuery struct {
	...
	Op        PairQuery_BinaryOp `protobuf:"varint,1,opt,name=op,proto3,enum=banyandb.model.v2.PairQuery_BinaryOp" json:"op,omitempty"`
...
type TypedPair_NullWithType struct {
	...
	Type v2.TagType `protobuf:"varint,1,opt,name=type,proto3,enum=banyandb.database.v2.TagType" json:"type,omitempty"`
}
...
func (*TypedPair_NullWithType) Descriptor() ([]byte, []int) {
	return file_banyandb_model_v2_query_proto_rawDescGZIP(), []int{0, 0}
}

func (x *TypedPair_NullWithType) GetType() v2.TagType {
	if x != nil {
		return x.Type
	}
	return v2.TagType(0)
...
var file_banyandb_model_v2_query_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x2f, 0x76, 0x32, 0x2f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61,
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xa7, 0x03, 0x0a, 0x09, 0x54, 0x79, 0x70, 0x65, 0x64,
	...
	0x61, 0x6e, 0x64, 0x62, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e, 0x76, 0x32, 0x2e, 0x54, 0x79,
	...
	0x64, 0x65, 0x6c, 0x2e, 0x76, 0x32, 0x2e, 0x49, 0x6e, 0x74, 0x48, 0x00, 0x52, 0x07, 0x69, 0x6e,
	...
	0x64, 0x65, 0x6c, 0x2e, 0x76, 0x32, 0x2e, 0x49, 0x6e, 0x74, 0x41, 0x72, 0x72, 0x61, 0x79, 0x48,
	...
	,
	...
	0x49, 0x4e, 0x47, 0x10, 0x08, 0x22, 0x9a, 0x01, 0x0a, 0x0a, 0x51, 0x75, 0x65, 0x72, 0x79, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x12, 0x19, 0x0a, 0x08, 0x6b, 0x65, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x10, 0x02, 0x22, 0x4a, 0x0a, 0x0a, 0x50, 0x72, 0x6f, 0x6a, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e,
	0x12, 0x1f, 0x0a, 0x0b, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x62, 0x69, 0x6e, 0x61, 0x72, 0x79, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x64, 0x61, 0x74, 0x61, 0x42, 0x69, 0x6e, 0x61, 0x72,
	0x79, 0x12, 0x1b, 0x0a, 0x09, 0x6b, 0x65, 0x79, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x73, 0x18, 0x02,
	0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x4e, 0x61, 0x6d, 0x65, 0x73, 0x22, 0x6b,
	0x0a, 0x09, 0x54, 0x69, 0x6d, 0x65, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x30, 0x0a, 0x05, 0x62,
	0x65, 0x67, 0x69, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x67, 0x6f, 0x6f,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x54, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x03, 0x65, 0x6e, 0x64, 0x42, 0x6c, 0x0a, 0x27, 0x6f,
...
var file_banyandb_model_v2_query_proto_goTypes = []interface{}{
	(PairQuery_BinaryOp)(0),        // 0: banyandb.model.v2.PairQuery.BinaryOp
	(QueryOrder_Sort)(0),           // 1: banyandb.model.v2.QueryOrder.Sort
	(*TypedPair)(nil),              // 2: banyandb.model.v2.TypedPair
	(*PairQuery)(nil),              // 3: banyandb.model.v2.PairQuery
	(*QueryOrder)(nil),             // 4: banyandb.model.v2.QueryOrder
	(*Projection)(nil),             // 5: banyandb.model.v2.Projection
	(*TimeRange)(nil),              // 6: banyandb.model.v2.TimeRange
	(*TypedPair_NullWithType)(nil), // 7: banyandb.model.v2.TypedPair.NullWithType
	(*Int)(nil),                    // 8: banyandb.model.v2.Int
	(*Str)(nil),                    // 9: banyandb.model.v2.Str
	(*IntArray)(nil),               // 10: banyandb.model.v2.IntArray
	(*StrArray)(nil),               // 11: banyandb.model.v2.StrArray
	(*timestamppb.Timestamp)(nil),  // 12: google.protobuf.Timestamp
	(v2.TagType)(0),                // 13: banyandb.database.v2.TagType
}
var file_banyandb_model_v2_query_proto_depIdxs = []int32{
	7,  // 0: banyandb.model.v2.TypedPair.null_pair:type_name -> banyandb.model.v2.TypedPair.NullWithType
	8,  // 1: banyandb.model.v2.TypedPair.int_pair:type_name -> banyandb.model.v2.Int
	9,  // 2: banyandb.model.v2.TypedPair.str_pair:type_name -> banyandb.model.v2.Str
	10, // 3: banyandb.model.v2.TypedPair.int_array_pair:type_name -> banyandb.model.v2.IntArray
	11, // 4: banyandb.model.v2.TypedPair.str_array_pair:type_name -> banyandb.model.v2.StrArray
	0,  // 5: banyandb.model.v2.PairQuery.op:type_name -> banyandb.model.v2.PairQuery.BinaryOp
	2,  // 6: banyandb.model.v2.PairQuery.condition:type_name -> banyandb.model.v2.TypedPair
	1,  // 7: banyandb.model.v2.QueryOrder.sort:type_name -> banyandb.model.v2.QueryOrder.Sort
	12, // 8: banyandb.model.v2.TimeRange.begin:type_name -> google.protobuf.Timestamp
	12, // 9: banyandb.model.v2.TimeRange.end:type_name -> google.protobuf.Timestamp
	13, // 10: banyandb.model.v2.TypedPair.NullWithType.type:type_name -> banyandb.database.v2.TagType
...
func file_banyandb_model_v2_query_proto_init() {
	...
	file_banyandb_model_v2_query_proto_msgTypes[0].OneofWrappers = []interface{}{
