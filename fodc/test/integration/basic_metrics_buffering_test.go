...
func TestBasicMetricsBuffering(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Basic Metrics Buffering E2E Suite")
}
...
var _ = ReportAfterSuite("Basic Metrics Buffering E2E Suite", func(report Report) {
