...
func setupFailureFixture() *failureFixture {
	...
	svc := grpcproxy.NewFODCService(reg, agg, nil, nil, nil, testLogger, heartbeatInterval)
	...
	httpSrv := api.NewServer(agg, nil, nil, reg, nil, testLogger)
...
var _ = Describe("Failure Scenarios", func() {
	...
	It("recovers after the proxy's gRPC service restarts", func() {
		...
		fixture.service = grpcproxy.NewFODCService(fixture.registry, fixture.aggregator, nil, nil, nil, fixture.logger, 2*time.Second)
