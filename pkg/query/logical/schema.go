...
func (s *schema) IndexDefined(tag *Tag) (bool, *databasev1.IndexRule) {
	for _, idxRule := range s.indexRules {
...
func (s *schema) registerField(tagName string, tagFamilyIdx, tagIdx int, spec *databasev1.TagSpec) {
