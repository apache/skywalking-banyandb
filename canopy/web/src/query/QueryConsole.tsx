...
function ResultViewRouter({ state, response, showTrace, setShowTrace, hasMore, onLoadMore, isLoadingMore, execMs, tags, interval }: {
  ...
  switch (state.catalog) {
    ...
    case 'measures':
      ...
      />;
    case 'streams':
      return <StreamResultView response={response} state={state} showTrace={showTrace} setShowTrace={setShowTrace} execMs={execMs} />;
    case 'traces':
