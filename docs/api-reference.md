...
| merge_grace | [google.protobuf.Duration](#google-protobuf-Duration) |  | merge_grace is the per-trace maturity window for the in-merge filter. Strictly positive if set; engine default 2h if unset. |
