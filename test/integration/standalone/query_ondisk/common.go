...
// Package queryondisk provides shared test setup for on-disk query integration tests.
package queryondisk
...
var _ = ginkgo.ReportAfterSuite("Integration Query OnDisk Suite", func(report ginkgo.Report) {
