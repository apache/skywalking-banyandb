...
func init() {
	multisegments.SetupFunc = func() multisegments.SetupResult {
		...
		By("Loading schema")
		setup.PreloadSchemaViaEtcd(ep, test_stream.PreloadSchema, test_measure.PreloadSchema, test_trace.PreloadSchema, test_property.PreloadSchema)
...
func TestEtcdMultiSegments(t *testing.T) {
	RegisterFailHandler(Fail)
	RunSpecs(t, "Distributed Etcd Multi Segments Suite")
}
