...
var traceEntries = []any{
	...
	g.Entry("gen_feat_order_duration_asc_limit2_offset1_proj_explicit_1", helpers.Args{Input: "gen_feat_order_duration_asc_limit2_offset1_proj_explicit_1", Duration: 1 * time.Hour}),
	g.Entry("gen_feat_traceid_limit5_offset3_proj_explicit_2", helpers.Args{Input: "gen_feat_traceid_limit5_offset3_proj_explicit_2", WantEmpty: true, DisOrder: true, Duration: 1 * time.Hour}),
	...
	g.Entry("gen_feat_order_duration_desc_filter_service_eq_limit2_7", helpers.Args{Input: "gen_feat_order_duration_desc_filter_service_eq_limit2_7", Duration: 1 * time.Hour}),
	g.Entry("gen_feat_order_timestamp_asc_filter_state_eq_limit5_offset1_proj_explicit_8", helpers.Args{Input: "gen_feat_order_timestamp_asc_filter_state_eq_limit5_offset1_proj_explicit_8", Duration: 1 * time.Hour}),
	g.Entry("gen_feat_order_timestamp_desc_filter_duration_range_limit2_9", helpers.Args{Input: "gen_feat_order_timestamp_desc_filter_duration_range_limit2_9", Duration: 1 * time.Hour}),
}
