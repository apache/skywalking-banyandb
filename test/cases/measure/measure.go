...
var measureEntries = []any{
	...
	g.Entry("float64 top 3 by value DESC", helpers.Args{Input: "float_top", Duration: 25 * time.Minute, Offset: -20 * time.Minute}),
	g.Entry("float64 bottom 3 by value ASC", helpers.Args{Input: "float_bottom", Duration: 25 * time.Minute, Offset: -20 * time.Minute}),
	g.Entry("float64 sum top 3 by value DESC", helpers.Args{Input: "float_top_sum", Duration: 25 * time.Minute, Offset: -20 * time.Minute}),
	g.Entry("float64 count top 3 by value DESC", helpers.Args{Input: "float_top_count", Duration: 25 * time.Minute, Offset: -20 * time.Minute}),
	g.Entry("float64 mean top 3 by value DESC", helpers.Args{Input: "float_top_mean", Duration: 25 * time.Minute, Offset: -20 * time.Minute}),
