...
func TestHalfDataStep1(t *testing.T) {
	...
	ginkgo.RunSpecs(t, "Half Data Step1: Initial Load Test Suite", ginkgo.Label("integration", "slow"))
}
...
var _ = ginkgo.Describe("Initial Load with 2 Copies", func() {
	...
	ginkgo.It("should create group with 2 copies, write 5k properties, then reduce copies to 1", func() {
