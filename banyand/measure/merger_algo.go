...
func (s *noopMergePolicy) GetPartsToMerge(pws []*partWrapper, _ uint64) []*partWrapper {
	return pws
}
...
func (l *lowestWriteAmplificationMergePolicy) GetPartsToMerge(pws []*partWrapper, maxFanOut uint64) []*partWrapper {
	//TODO implement me
	panic("implement me")
}
