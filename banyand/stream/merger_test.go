...
func Test_mergeParts(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want: []blockMetadata{
				{seriesID: 1, count: 2448, uncompressedSizeBytes: 2156688},
				{seriesID: 1, count: 2448, uncompressedSizeBytes: 2156688},
				{seriesID: 1, count: 2552, uncompressedSizeBytes: 2248312},
				{seriesID: 1, count: 2448, uncompressedSizeBytes: 2156688},
				{seriesID: 1, count: 104, uncompressedSizeBytes: 91624},
